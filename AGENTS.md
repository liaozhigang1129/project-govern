...
project-govern 是 **Spring Boot 3.3 + Java 21 + Vue 3.5** 的前后端分离项目,治理视角的项目全生命周期管理系统。当前进度、风险、决策快照一律在 [STATUS.md](docs/STATUS.md);任务分解在 [WBS.md](docs/WBS.md);版本历史在 [CHANGELOG.md](docs/CHANGELOG.md)。**AGENTS.md 不放现状与进度,只放指针与规则。**
