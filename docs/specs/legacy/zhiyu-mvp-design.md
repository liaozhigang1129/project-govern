...
把"知驭 ZhiYu MVP"从代码反推成**一份给新同学 / 接手人的技术地图**:
...
| **容器** | Docker Compose | v2 | 3 服务,共享 `zhiyu-net` |
...
# 或 newman 跑 Postman
newman run zhiyu-pms.postman_collection.json -e zhiyu-pms.postman_environment.json
...
| `SPRING_DATASOURCE_PASSWORD` | `zhiyu_pms_dev_2025` | secret manager |
