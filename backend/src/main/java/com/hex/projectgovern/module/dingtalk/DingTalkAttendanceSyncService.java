...
import com.hex.projectgovern.module.notification.DingTalkChannel;
...
public class DingTalkAttendanceSyncService {
    ...
    private final com.hex.projectgovern.module.project.ProjectRepository projectRepo;
    ...
    private void sendFailureAlert(DingTalkAttendanceSyncLog slog) {
        try {
            ...
            try {
                com.hex.projectgovern.module.notification.NotificationMessage msg =
                    new com.hex.projectgovern.module.notification.NotificationMessage(
