...
import com.hex.projectgovern.module.risk.dto.*;
import com.hex.projectgovern.module.risk.dto.RiskResponse;
...
public class RiskService {
    ...
    public RiskResponseDto.Item upsertResponse(Long riskId, RiskResponseDto.Request req, Long operatorId) {
        ...
        com.hex.projectgovern.module.risk.RiskResponse resp = (req.id() == null)
                ? new com.hex.projectgovern.module.risk.RiskResponse()
        ...
        com.hex.projectgovern.module.risk.RiskResponse saved = responseRepository.save(resp);
    ...
    public void deleteResponse(Long responseId, Long operatorId) {
        com.hex.projectgovern.module.risk.RiskResponse resp = responseRepository.findById(responseId)
    ...
    private RiskResponseDto.Item toResponseItem(com.hex.projectgovern.module.risk.RiskResponse resp) {
