...
import com.hex.projectgovern.module.org.dto.UserRoleAssignRequest;
...
public class UserRoleAdminController {
    ...
    @Transactional
    public ApiResponse<Map<String, Object>> batchAssign(@RequestBody @Valid com.hex.projectgovern.module.org.dto.BatchUserRoleAssignRequest req) {
