...
public class Risk extends SoftDeletableEntity {
    ...
    public static String levelOf(int score, com.company.pmo.module.admin.SystemConfigService cfg) {
    ...
    public void recomputeScoreAndLevel(com.company.pmo.module.admin.SystemConfigService cfg) {
