...
import com.company.pmo.module.org.dto.UserRoleAssignRequest;
...
public class UserRoleAdminController {
    ...
    @Transactional
    public ApiResponse<Map<String, Object>> batchAssign(@RequestBody @Valid com.company.pmo.module.org.dto.BatchUserRoleAssignRequest req) {
