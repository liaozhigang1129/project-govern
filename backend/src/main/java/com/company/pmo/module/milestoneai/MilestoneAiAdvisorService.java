...
import com.company.pmo.module.milestone.MilestoneAnalysisService;
...
import com.company.pmo.module.risk.dto.RiskRequest;
import org.springframework.data.domain.PageRequest;
import org.springframework.data.domain.Pageable;
import com.company.pmo.module.risk.RiskService;
 ...
 *  com.company.pmo.module.notification.MilestoneAdvisoryDecidedEvent → NotificationDispatcherListener 异步消费
 */
@Service
...
public class MilestoneAiAdvisorService {
    ...
    public MilestoneAiAdvisoryDto apply(Long advisoryId, Long operatorId) {
        ...
        com.company.pmo.module.risk.dto.RiskResponse risk = riskService.save(req, operatorId);
        a.setStatus("APPLIED");
    ...
    private List<com.company.pmo.module.milestoneai.MilestoneAiSignalDto> toSignalDtos(List<MilestoneAiSignal> sigs) {
        if (sigs == null) return List.of();
        List<com.company.pmo.module.milestoneai.MilestoneAiSignalDto> r = new java.util.ArrayList<>();
        for (MilestoneAiSignal s : sigs) r.add(toSignalDto(s));
        return r;
    }

    private com.company.pmo.module.milestoneai.MilestoneAiSignalDto toSignalDto(MilestoneAiSignal s) {
        return new com.company.pmo.module.milestoneai.MilestoneAiSignalDto(
                s.getId(),
    ...
    private void publishAdvisoryEvent(MilestoneAiAdvisory advisory, Project p, Milestone m) {
        try {
            ...
            com.company.pmo.module.notification.MilestoneAdvisoryDecidedEvent event = new com.company.pmo.module.notification.MilestoneAdvisoryDecidedEvent(
