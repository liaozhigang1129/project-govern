...
import com.company.pmo.module.dict.ApprovalStep;
import com.company.pmo.module.dict.ApprovalStepRepository;
...
import com.company.pmo.module.notification.InitiationDecidedEvent;
import com.company.pmo.module.notification.InitiationResubmittedEvent;
import com.company.pmo.module.notification.InitiationSubmittedEvent;
...
public class InitiationService {
    ...
    public ProjectInitiation updateFields(Long initiationId,
        ...
        ProjectInitiation i = initiationRepository.findActiveById(initiationId)
                .orElseThrow(() -> new com.company.pmo.common.exception.BusinessException(
