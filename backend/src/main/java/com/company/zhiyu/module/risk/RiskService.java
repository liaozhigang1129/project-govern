...
public class RiskService {
    ...
    public RiskResponseDto.Item upsertResponse(Long riskId, RiskResponseDto.Request req, Long operatorId) {
        ...
        com.company.zhiyu.module.risk.RiskResponse resp = (req.id() == null)
                ? new com.company.zhiyu.module.risk.RiskResponse()
        ...
        com.company.zhiyu.module.risk.RiskResponse saved = responseRepository.save(resp);
    ...
    public void deleteResponse(Long responseId, Long operatorId) {
        com.company.zhiyu.module.risk.RiskResponse resp = responseRepository.findById(responseId)
    ...
    private RiskResponseDto.Item toResponseItem(com.company.zhiyu.module.risk.RiskResponse resp) {
