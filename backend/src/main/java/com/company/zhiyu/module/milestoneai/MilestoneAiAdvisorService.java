...
import com.company.zhiyu.module.milestone.MilestoneAnalysisService;
...
import com.company.zhiyu.module.risk.RiskService;
 ...
 *  com.company.zhiyu.module.notification.MilestoneAdvisoryDecidedEvent → NotificationDispatcherListener 异步消费
 */
@Service
...
public class MilestoneAiAdvisorService {
    ...
    public MilestoneAiAdvisoryDto apply(Long advisoryId, Long operatorId) {
        ...
        com.company.zhiyu.module.risk.dto.RiskResponse risk = riskService.save(req, operatorId);
        a.setStatus("APPLIED");
    ...
    private List<com.company.zhiyu.module.milestoneai.MilestoneAiSignalDto> toSignalDtos(List<MilestoneAiSignal> sigs) {
        if (sigs == null) return List.of();
        List<com.company.zhiyu.module.milestoneai.MilestoneAiSignalDto> r = new java.util.ArrayList<>();
        for (MilestoneAiSignal s : sigs) r.add(toSignalDto(s));
        return r;
    }

    private com.company.zhiyu.module.milestoneai.MilestoneAiSignalDto toSignalDto(MilestoneAiSignal s) {
        return new com.company.zhiyu.module.milestoneai.MilestoneAiSignalDto(
                s.getId(),
    ...
    private void publishAdvisoryEvent(MilestoneAiAdvisory advisory, Project p, Milestone m) {
        try {
            ...
            com.company.zhiyu.module.notification.MilestoneAdvisoryDecidedEvent event = new com.company.zhiyu.module.notification.MilestoneAdvisoryDecidedEvent(
