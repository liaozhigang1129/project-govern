...
import com.company.zhiyu.module.dict.ApprovalStep;
import com.company.zhiyu.module.dict.ApprovalStepRepository;
...
import com.company.zhiyu.module.notification.InitiationDecidedEvent;
import com.company.zhiyu.module.notification.InitiationResubmittedEvent;
import com.company.zhiyu.module.notification.InitiationSubmittedEvent;
...
public class InitiationService {
    ...
    public ProjectInitiation updateFields(Long initiationId,
        ...
        ProjectInitiation i = initiationRepository.findActiveById(initiationId)
                .orElseThrow(() -> new com.company.zhiyu.common.exception.BusinessException(
