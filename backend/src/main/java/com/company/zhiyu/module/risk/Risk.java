...
public class Risk extends SoftDeletableEntity {
    ...
    public static String levelOf(int score, com.company.zhiyu.module.admin.SystemConfigService cfg) {
    ...
    public void recomputeScoreAndLevel(com.company.zhiyu.module.admin.SystemConfigService cfg) {
