...
import com.company.zhiyu.module.notification.DingTalkChannel;
...
public class DingTalkAttendanceSyncService {
    ...
    private final com.company.zhiyu.module.project.ProjectRepository projectRepo;
    ...
    private void sendFailureAlert(DingTalkAttendanceSyncLog slog) {
        try {
            ...
            try {
                com.company.zhiyu.module.notification.NotificationMessage msg =
                    new com.company.zhiyu.module.notification.NotificationMessage(
