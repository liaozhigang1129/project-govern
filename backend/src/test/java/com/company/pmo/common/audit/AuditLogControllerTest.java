...
class AuditLogControllerTest {
    ...
    @Autowired com.company.pmo.module.org.UserRepository userRepository;
    @Autowired com.company.pmo.module.org.RoleRepository roleRepository;
    ...
    void setUp() {
        ...
        com.company.pmo.module.org.AppUser admin = new com.company.pmo.module.org.AppUser();
        ...
        com.company.pmo.module.org.AppUser viewer = new com.company.pmo.module.org.AppUser();
    ...
    private com.company.pmo.module.org.Role ensureRole(String code, String name) {
        return roleRepository.findAll().stream()
                .filter(r -> code.equals(r.getCode()))
                .findFirst()
                .orElseGet(() -> {
                    var r = new com.company.pmo.module.org.Role();
                    r.setCode(code);
                    r.setName(name);
    ...
    private com.company.pmo.module.org.AppUser ensureUser(String username, String pw, String fullName,
                                                          String roleCode) {
        return userRepository.findByUsernameAndDeletedFalse(username).orElseGet(() -> {
            ...
            var u = new com.company.pmo.module.org.AppUser();
