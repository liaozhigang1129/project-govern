...
class RiskControllerTest {
    ...
    @MockBean com.company.pmo.common.security.SecurityUtils securityUtils;
    ...
    void getById_returns200() throws Exception {
        var r = new com.company.pmo.module.risk.dto.RiskResponse(
    ...
    void health_returns200() throws Exception {
        var s = new com.company.pmo.module.risk.dto.RiskHealthSummary(
    ...
    void matrix_returns200() throws Exception {
        var cells = new java.util.ArrayList<com.company.pmo.module.risk.dto.RiskMatrix.Cell>();
        for (int p = 1; p <= 5; p++) {
            for (int i = 1; i <= 5; i++) {
                cells.add(new com.company.pmo.module.risk.dto.RiskMatrix.Cell(p, i, 0, List.of()));
            }
        }
        when(riskService.matrix(3L)).thenReturn(new com.company.pmo.module.risk.dto.RiskMatrix.Matrix(cells));
