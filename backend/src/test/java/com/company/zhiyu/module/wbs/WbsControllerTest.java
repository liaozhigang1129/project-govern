...
import com.company.zhiyu.module.wbs.dto.BudgetSnapshotResponse;
import com.company.zhiyu.module.wbs.dto.WbsAssignmentRequest;
import com.company.zhiyu.module.wbs.dto.WbsAssignmentResponse;
import com.company.zhiyu.module.wbs.dto.WbsProgressSummary;
import com.company.zhiyu.module.wbs.dto.WbsTaskNode;
import com.company.zhiyu.module.wbs.dto.WbsTaskRequest;
...
class WbsControllerTest {
    ...
    @MockBean com.company.zhiyu.common.security.JwtAuthFilter jwtAuthFilter;
    @MockBean com.company.zhiyu.common.security.JwtService jwtService;
    @MockBean com.company.zhiyu.common.audit.OperationLogAspect operationLogAspect;
    ...
    void ganttByProject_returns200() throws Exception {
        com.company.zhiyu.module.wbs.dto.WbsGanttRow row =
                new com.company.zhiyu.module.wbs.dto.WbsGanttRow(
                        10L, "1.1", "需求分析", 0, 1L,
        ...
        com.company.zhiyu.module.wbs.dto.WbsGanttResponse resp =
                new com.company.zhiyu.module.wbs.dto.WbsGanttResponse(
