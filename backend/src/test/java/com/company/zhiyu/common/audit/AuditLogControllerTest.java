...
import com.company.zhiyu.common.security.JwtService;
...
class AuditLogControllerTest {
    ...
    @Autowired com.company.zhiyu.module.org.UserRepository userRepository;
    @Autowired com.company.zhiyu.module.org.RoleRepository roleRepository;
    ...
    void setUp() {
        ...
        com.company.zhiyu.module.org.AppUser admin = new com.company.zhiyu.module.org.AppUser();
        ...
        com.company.zhiyu.module.org.AppUser viewer = new com.company.zhiyu.module.org.AppUser();
    ...
    private com.company.zhiyu.module.org.Role ensureRole(String code, String name) {
        return roleRepository.findAll().stream()
                .filter(r -> code.equals(r.getCode()))
                .findFirst()
                .orElseGet(() -> {
                    var r = new com.company.zhiyu.module.org.Role();
                    r.setCode(code);
                    r.setName(name);
    ...
    private com.company.zhiyu.module.org.AppUser ensureUser(String username, String pw, String fullName,
                                                          String roleCode) {
        return userRepository.findByUsernameAndDeletedFalse(username).orElseGet(() -> {
            ...
            var u = new com.company.zhiyu.module.org.AppUser();
